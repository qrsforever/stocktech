...
export JAVA_OPTS="$JAVA_OPTS -Dhivemq.config.folder=${stoctech_hivemq_dir}/conf"
export JAVA_OPTS="$JAVA_OPTS -Dhivemq.extensions.folder=${stoctech_hivemq_dir}/extensions"
